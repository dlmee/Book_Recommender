...
dfp3 <- matrix(sample(0:5, replace = TRUE), nrow=7, ncol=6)
featcount <- ncol(tbf)
...
factored2 <- factorization(sampler, 500, .0001, .002, 9)

nf <- factorization(dfp3, 500, .001, .02)
...
recommendation <- recommender('236146', factored, ifactored)
